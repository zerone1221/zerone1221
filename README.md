...
## 🚀 Tech Enthusiast | Computer Engineering Student | Linux & Networking Learner

`Learning by Building` • `Breaking to Understand` • `Fixing to Improve`
...
Halo! Aku **Bima**, mahasiswa **Teknologi Rekayasa Komputer** yang tertarik dengan dunia teknologi, terutama:

- 🐧 Linux & server management
- 🌐 Networking & web server
- 🤖 WhatsApp bot development
- 💻 Web development
- 📱 Android, custom ROM, and device tweaking
- 🔧 Hardware tinkering and soldering

Aku suka belajar teknologi dengan cara langsung praktik, mencoba, error, lalu memperbaiki sampai paham.
...
![Ubuntu](https://img.shields.io/badge/Ubuntu-222?style=for-the-badge&logo=ubuntu)
![Apache](https://img.shields.io/badge/Apache-222?style=for-the-badge&logo=apache)
...
- Basic cybersecurity and networking
...
> Error bukan akhir, tapi bagian dari proses belajar.  
> Selama masih bisa dicoba, berarti masih bisa dipahami.
